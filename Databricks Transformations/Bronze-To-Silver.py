...
df_customers = spark.read.format("csv").load("abfss://bronze@olistdatalake0.dfs.core.windows.net/olist_customers_dataset.csv")
df_geolocation = spark.read.format("csv").load("abfss://bronze@olistdatalake0.dfs.core.windows.net/olist_geolocation_dataset.csv") 
df_order_items = spark.read.format("csv").load("abfs://bronze@olistdatalake0.dfs.core.windows.net/olist_order_items_dataset.csv")
df_order_payments = spark.read.format("csv").load("abfss://bronze@olistdatalake0.dfs.core.windows.net/olist_order_payments_dataset.csv")
df_order_reviews = spark.read.format("csv").load("abfss://bronze@olistdatalake0.dfs.core.windows.net/olist_order_reviews_dataset.csv")

df_products = spark.read.format("csv").load("abfss://bronze@olistdatalake0.dfs.core.windows.net/olist_products_dataset.csv")
df_sellers = spark.read.format("csv").load("abfss://bronze@olistdatalake0.dfs.core.windows.net/olist_sellers_dataset.csv")
df_product_category_name_translation = spark.read.format("csv").load("abfss://bronze@olistdatalake0.dfs.core.windows.net/product_category_name_translation.csv")


# COMMAND ----------

df_orders = spark.read.format("csv").load("abfss://bronze@olistdatalake0.dfs.core.windows.net/olist_orders_dataset.csv")
...
df_customers.write.format("delta")\
               .mode("overwrite")\
                .option("path", "abfss://silver@olistdatalake0.dfs.core.windows.net/customers")\
                .save()
...
df_geolocation.write.format("delta")\
                    .mode("overwrite")\
                    .option("path", "abfss://silver@olistdatalake0.dfs.core.windows.net/geolocation")\
                    .save()
...
df_order_items.write.format("delta")\
                    .mode("overwrite")\
                    .option("path", "abfss://silver@olistdatalake0.dfs.core.windows.net/order_items")\
                    .save()
...
df_order_payments.write.format("delta")\
                     .mode("overwrite")\
                     .option("path", "abfss://silver@olistdatalake0.dfs.core.windows.net/order_payments")\
                     .save()
...
df_order_reviews.write.format("delta")\
                     .mode("overwrite")\
                     .option("path", "abfss://silver@olistdatalake0.dfs.core.windows.net/order_reviews")\
                     .save()
...
df_orders.write.format("delta")\
            .mode("overwrite")\
            .option("path", "abfss://silver@olistdatalake0.dfs.core.windows.net/orders")\
            .save()
...
df_products.write.format("delta")\
            .mode("overwrite")\
            .option("path", "abfss://silver@olistdatalake0.dfs.core.windows.net/products")\
            .save()
...
df_sellers.write.format("delta")\
                .mode("overwrite")\
                .option("path", "abfss://silver@olistdatalake0.dfs.core.windows.net/sellers")\
                .save()
